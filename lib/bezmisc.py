...
def bezierparameterize(parameters):
    ((bx0, by0), (bx1, by1), (bx2, by2), (bx3, by3)) = parameters
    #parametric bezier
    x0=bx0
    y0=by0
    cx=3*(bx1-x0)
...
def linebezierintersect(parameters):
    ((lx1, ly1), (lx2, ly2)), ((bx0, by0), (bx1, by1), (bx2, by2), (bx3, by3)) = parameters
    #parametric line
    dd=lx1
    cc=lx2-lx1
    bb=ly1
...
def bezierpointatt(parameters, t):
    ((bx0, by0), (bx1, by1), (bx2, by2), (bx3, by3)) = parameters
    ax,ay,bx,by,cx,cy,x0,y0=bezierparameterize(((bx0,by0),(bx1,by1),(bx2,by2),(bx3,by3)))
...
def bezierslopeatt(parameters, t):
    ((bx0, by0), (bx1, by1), (bx2, by2), (bx3, by3)) = parameters
    ax,ay,bx,by,cx,cy,x0,y0=bezierparameterize(((bx0,by0),(bx1,by1),(bx2,by2),(bx3,by3)))
...
def beziertatslope(parameters, deltas):
    ((bx0, by0), (bx1, by1), (bx2, by2), (bx3, by3)) = parameters
    (dy, dx) = deltas
    ax,ay,bx,by,cx,cy,x0,y0=bezierparameterize(((bx0,by0),(bx1,by1),(bx2,by2),(bx3,by3)))
...
def tpoint(first, second, t):
    (x1, y1) = first
    (x2, y2) = second
    return x1+t*(x2-x1),y1+t*(y2-y1)


def beziersplitatt(parameters, t):
    ((bx0, by0), (bx1, by1), (bx2, by2), (bx3, by3)) = parameters
...
def bezierlengthSimpson(parameters, tolerance = 0.001):
    ((bx0, by0), (bx1, by1), (bx2, by2), (bx3, by3)) = parameters
...
def beziertatlength(parameters, l = 0.5, tolerance = 0.001):
    ((bx0, by0), (bx1, by1), (bx2, by2), (bx3, by3)) = parameters
    global balfax,balfbx,balfcx,balfay,balfby,balfcy
    ax,ay,bx,by,cx,cy,x0,y0=bezierparameterize(((bx0,by0),(bx1,by1),(bx2,by2),(bx3,by3)))
    balfax,balfbx,balfcx,balfay,balfby,balfcy = 3*ax,2*bx,cx,3*ay,2*by,cy
